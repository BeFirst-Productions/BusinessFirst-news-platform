...
import { articleKeys, categoryKeys } from '@/web/lib/query-keys';
import type { Article, Category } from '@businessfirst/shared-types';

// Import components
import TopHeadlines from '@/web/components/TopHeadlines';
...
import NewsGridSection from '@/web/components/NewsGridSection';
import CategoryNewsSection from '@/web/components/CategoryNewsSection';
import LogisticsAviationSection from '@/web/components/LogisticsAviationSection';
import SponsoredContents from '@/web/components/SponsoredContents';
import TechnologyInnovation from '@/web/components/TechnologyInnovation';
import NewsletterBanner from '@/web/components/NewsletterBanner';
import OilSportsSection from '@/web/components/OilSportsSection';
import BankingFinanceSection from '@/web/components/BankingFinanceSection';
import DailyInsightsSection from '@/web/components/DailyInsightsSection';
import HealthcareTourismSection from '@/web/components/HealthcareTourismSection';
import EventsSection from '@/web/components/EventsSection';
import MediaCoverageSection from '@/web/components/MediaCoverageSection';
import CultureLifestyleSection from '@/web/components/CultureLifestyleSection';
import SocialMediaSection from '@/web/components/SocialMediaSection';

// Skeleton loaders for Suspense fallbacks
import { Skeleton } from '@/web/components/ui/Skeleton';
import { AdBannerSkeleton } from '@/web/components/ads/AdBannerSkeleton';
