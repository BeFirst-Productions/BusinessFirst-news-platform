...
export const PRESET_PAGES: PresetPageDef[] = [
  ...
  },
  {
    ...
    label:           'UAE News',
    pageType:        'CUSTOM',
    metaTitle:       'UAE News – BusinessFirst',
...
export class SeoService {
  ...
  static async getPageSeoBySlug(slug: string) {
    ...
    // Fallback: If not found by exact SEO slug, but it's a category request,
    // try to find the SEO record by the actual category slug.
    if (!record && slug.startsWith('category/')) {
