...
const SponsoredContents = () => {
  ...
  const articles = rawArticles.map((h) => ({
    id: h.id,
    title: h.title,
    date: h.publishedAt
      ...
      {articles.length === 0 ? (
        ...
        <>
          ...
          <div className="mt-12 flex justify-center">
            <Link href="/news?isSponsored=true" className="bg-[#cd2027] hover:bg-[#a61a1f] text-white px-6 py-2 rounded font-bold text-sm uppercase tracking-wider transition flex items-center justify-center gap-1">
