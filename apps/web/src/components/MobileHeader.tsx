  ...
  return (
    <div className="flex flex-col w-full">
      <div className="relative">
        ...
        >
          <div className="cursor-pointer" onClick={() => { setIsMenuOpen(!isMenuOpen); setIsSearchOpen(false); }}>
            {isMenuOpen ? (
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {isSearchOpen ? <X size={18} className="text-[#24214c]" strokeWidth={2} /> : <Search size={18} className="text-[#24214c]" strokeWidth={2} />}
            </div>
          </div>
        </SectionContainer>
