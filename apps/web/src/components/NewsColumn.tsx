          ...
          {featured && (
            <Link href={`/news/${featured.id}`} className="flex flex-col gap-2 group cursor-pointer w-full">
              ...
              <div className="flex flex-col gap-0.5 mt-1">
                <span className="text-[11px] md:text-[12px] font-bold text-[#cd2027] uppercase tracking-wider truncate">
                  {featured.category}
                </span>
                <span className="text-[11px] md:text-[12px] text-gray-500 font-medium whitespace-nowrap">
                  {featured.date}
                </span>
              </div>
                ...
                <Link href={`/news/${item.id}`} key={item.id} className="flex flex-col group cursor-pointer h-full">
                  ...
                  <div className="flex flex-col flex-1 justify-between gap-1.5">
                    ...
                    <div className="flex flex-col gap-0.5 mt-auto">
                      ...
                      <span className="text-[10px] md:text-[11px] text-gray-500 font-medium whitespace-nowrap truncate">
                        {item.date}
                      </span>
                    </div>
                  </div>
